...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgb(be72d4)", "rgb(6c048a)"}, angle = 45 },
...
for i = 1, 10 do
    ...
    hl.bind(mainMod .. " + ALT + code:1" .. key,     hl.dsp.window.move({ workspace = i, follow = false }))
